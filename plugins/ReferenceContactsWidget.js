export default class MyPlugin {
  ...
  install(pluginManager) {
    ...
    const citecontent = React.createElement(
      ...
      React.createElement('p', null, 'A reference for AureoBrowse will be available soon.'),
    ...
    const contactcontent = React.createElement(
      ...
      React.createElement('p', null, 'Email: ', React.createElement("a", {href: "mailto:Veening.lab@gmail.com?subject=AureoBrowse"}, "Veening.lab@gmail.com" )),
    ...
    const availabilitycontent = React.createElement(
      ...
      React.createElement('p', null, 'Data within AureoBrowse will be available from the NCBI when the paper is published.'),
      React.createElement('p', null, ''))
